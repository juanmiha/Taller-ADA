with io_concc,Data_Types,Practica2_ImprimirPantalla,Ada.Real_Time,System,Ada.Dynamic_Priorities,ada.strings.unbounded,tarjeta_compartida,espera_selectiva,Ada.Integer_Text_IO;
use io_concc,Data_Types,Practica2_ImprimirPantalla,Ada.Real_Time,System,Ada.Dynamic_Priorities,ada.strings.unbounded,tarjeta_compartida,espera_selectiva,Ada.Integer_Text_IO;


procedure practica3_main_concurrente is
   
   
   task ControlNivelDeposito1 is 
      pragma Priority(3);
   end ControlNivelDeposito1;
   
   task ControlNivelDeposito2  is 
      pragma Priority(2);
   end ControlNivelDeposito2;
   
      
   task ControlDeTemperatura  is 
         pragma Priority(4);
   end ControlDeTemperatura;
   
   task ControlDeSeguridad  is 
      pragma Priority(1);
...
end practica3_main_concurrente;
